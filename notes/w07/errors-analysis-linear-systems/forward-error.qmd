...
# Define true solution, approximate solution, and error
x_true = np.array([2, 1])
x_a = np.array([1, -1])
e = x_true - x_a
...
# Plot vectors with high zorder to appear above the grid
...
# Annotate vectors with high zorder
...
# Highlight the maximum component of the error
