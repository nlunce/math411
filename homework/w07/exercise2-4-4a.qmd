...
- **Compute Multipliers and Eliminate Below Pivot**:
  ...
  - **Row 2**:
    ...
    $$
    $$
    \text{Row 2} \leftarrow \text{Row 2} - L_{21} \times \text{Row 1}
    $$
    $$
  ...
  - **Row 3**:
    ...
    $$
    $$
    \text{Row 3} \leftarrow \text{Row 3} - L_{31} \times \text{Row 1}
    $$
    $$
...
- **Compute Multiplier and Eliminate Below Pivot**:
  ...
  - **Row 3**:
    ...
    $$
    $$
    \text{Row 3} \leftarrow \text{Row 3} - L_{32} \times \text{Row 2}
    $$
    $$
